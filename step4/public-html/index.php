...
<head>
  ...
  <title>RES 2021 HTTP Infra</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">RES 2021 HTTP Infra</a></h1>
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>Bienvenue sur la page de l'étape 1</h1>
          <h2>tournant dans un Apache dockeurisé !</h2>
          <h2>Avec PHP d'activé | date/heure actuelle : <?php echo date('d-m-y h:i:s'); ?></h2>
        </div>
      </div>
